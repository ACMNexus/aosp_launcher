...
public class LauncherProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private int loadFavorites(SQLiteDatabase db, int workspaceResourceId) {
            ...
            try {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    if (LOGD) {
                        final String title = a.getString(R.styleable.Favorite_favtitle);
                    ...
                    if (TAG_FAVORITE.equals(name)) {
                        ...
                        String title;
                        int titleResId =  a.getResourceId(R.styleable.Favorite_favtitle, -1);
                        if (titleResId != -1) {
        ...
        private long addUriShortcut(SQLiteDatabase db, ContentValues values,
            ...
            final int iconResId = a.getResourceId(R.styleable.Favorite_favicon, 0);
