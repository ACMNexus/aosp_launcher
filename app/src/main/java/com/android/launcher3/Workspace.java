    ...
    public void onDrop(final DragObject d) {
        ...
        if (d.dragSource != this) {
            ...
            if (d.dragView.hasDrawn()) {
                final ItemInfo info = (ItemInfo) cell.getTag();
                if (info.itemType == Favorites.ITEM_TYPE_APPWIDGET) {
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            View finalView = pendingInfo.itemType == Favorites.ITEM_TYPE_APPWIDGET
            ...
            if (pendingInfo.itemType == Favorites.ITEM_TYPE_APPWIDGET &&
    ...
    public void animateWidgetDrop(ItemInfo info, CellLayout cellLayout, DragView dragView,
        ...
        } else if (info.itemType == Favorites.ITEM_TYPE_APPWIDGET && external) {
